...
NFC or Near Field Communication is a technology allowing data transfer not only between a reader and a compatible terminal. Released in France in 2012, we use it today in many applications : contactless payment, ticket validation in public transportation systems, tracking, etc.

Despite its growing popularity these past few years, the meaning and the modes of operation stay unclear for most of us. Given the usefulness of this subject, it is instructive to take a special interest in it.
...
[<img src="{{ site.baseurl }}/assets/images/nfc/fig08.png" width="100%">](https://www.bluebite.com/nfc/nfc-chips-technical-details-and-types "NFC Chips: Technical Details and Types (source: bluebite.com)") <font size=3pt> Fig. NFC Chips: Technical Details and Types (source: bluebite.com) </font>
...
With the reader mode, the (active) device become the contactless reader when close to (about 10cm away) a NFC tag. The possibilities for NFC tags are endless. They could be used on posters, monuments, luxury products, medication (to certify their origin), etc.
